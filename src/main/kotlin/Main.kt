...
fun limTransferPrint(card: String, monthlyTransfers: Int, amountTransfer: Int): Int {
    when (card) {
        CARD_1, CARD_2, CARD_3, CARD_4 -> if (amountTransfer > 150_000_00 || monthlyTransfers > 600_000_0) {
            return -1
        }
        CARD_5 -> if (amountTransfer > 15_000_00 || monthlyTransfers > 40_000_00)
            return -1
    }
    return 1
}